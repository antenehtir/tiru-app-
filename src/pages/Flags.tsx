...
const SUMMARY_CARDS = [
  {
    ...
    zero:  'text-red-300      dark:text-red-700',
  },
  {
    label: 'Late Arrivals',
    icon: Clock,
    card:  'border-orange-200 bg-orange-50 dark:bg-orange-900/20 dark:border-orange-800',
    icon_: 'text-orange-500',
    count: 'text-orange-600   dark:text-orange-400',
    zero:  'text-orange-300   dark:text-orange-700',
  },
  {
    label: 'Outside Geofence',
    icon: MapPin,
    card:  'border-amber-200  bg-amber-50  dark:bg-amber-900/20  dark:border-amber-800',
    icon_: 'text-amber-500',
    count: 'text-amber-600    dark:text-amber-400',
    zero:  'text-amber-300    dark:text-amber-700',
  },
  {
    label: 'Low Attendance',
    icon: TrendingDown,
    card:  'border-blue-200   bg-blue-50   dark:bg-blue-900/20   dark:border-blue-800',
    icon_: 'text-blue-500',
    count: 'text-blue-600     dark:text-blue-400',
    zero:  'text-blue-300     dark:text-blue-700',
  },
] as const
  ...
  return (
    <div className="p-6 space-y-6 max-w-6xl mx-auto">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div className="hidden md:grid grid-cols-[2fr_1.5fr_1.5fr_1fr_1.5fr_1fr] gap-4 px-5 py-3 bg-gray-50 dark:bg-gray-700/50 border-b border-gray-100 dark:border-gray-700 text-xs font-semibold uppercase tracking-wider text-gray-400">
        ...
        <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
          <ShieldCheck className="w-12 h-12 text-teal-300 dark:text-teal-700 mb-4" />
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-gray-100 dark:bg-gray-700">
          {FLAG_RULES.map(({ icon: Icon, iconClass, title, desc }) => (
            <div
              key={title}
              className="bg-white dark:bg-gray-800 px-5 py-4 flex items-start gap-3"
            >
